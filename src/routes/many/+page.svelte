...
<style>
    ...
    .logo {
        ...
        font-size: 32px;
        color: #111827; /* Tumma logo vaalealle taustalle */
        letter-spacing: 1px;
    }
    ...
    .nav-icons svg:hover {
        color: #00a896; /* Ikonit muuttuvat turkoosiksi koskettaessa */
    }
    ...
    .location {
        font-size: 13px;
        color: #6c757d; /* Vaaleammalle teemalle sopivampi harmaa sijainnille */
        margin: 0;
        margin-bottom: auto;
    }
</style>